...
<input type="button" name="Rank" value="Rank" onclick="window.location.href='http://128.163.141.190/registration.php'">
<input type="button" name="Team" value="Team Name" onclick="window.location.href='http://128.163.141.190/registration.php'">
<input type="button" name="Tournament" value="Tournament Name" onclick="window.location.href='http://128.163.141.190/registration.php'">
